      ...
      <div id="heroCarousel" class="carousel slide carousel-fade" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
          ...
          <div class="carousel-item">
            ...
            <div class="carousel-container">
              <div class="carousel-content">
                <h2 class="animate__animated animate__fadeInDown mb-0">Harshit, Sagar, Girish,</h2><p> <a href="https://github.com/Harshit-Sevak" target="_blank"></a></p>
                <a href="index.php" class="btn-get-started animate__animated animate__fadeInUp scrollto">Get Started</a>
              </div>
            </div>
          </div>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-6">
            ...
            <h3><strong>We are a team of three passionate developers — Harshit, Girish, and Sagar — who came together with a shared vision to build something meaningful and impactful. This web application is the result of our combined efforts, creativity, and dedication.</strong></h3>
            <p class="font-italic">
          </div>
            ...
            <div class="member">
              ...
              <div class="member-info">
                ...
                <div class="social">
                  ...
                  <a href="https://github.com/Harshit-Sevak" target="_blank"><i class="fab fa-github"></i></a>
